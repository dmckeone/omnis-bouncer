...
pub struct RunArgs {
    ...
    #[arg(
        long,
        default_value = "Omnis Studio Bouncer",
        env = "OMNIS_BOUNCER_NAME"
    )]
    pub name: String,

    /// Master key (in base64) for cookie encryption
    #[arg(long, env = "OMNIS_BOUNCER_COOKIE_KEY")]
    ...
    #[arg(long, num_args = 0.., value_delimiter = ',', env = "OMNIS_BOUNCER_UPSTREAM_URIS")]
    ...
    #[arg(long, default_value = "10", env = "OMNIS_BOUNCER_UPSTREAM_SESSIONS")]
    ...
    #[arg(long, default_value = "10", env = "OMNIS_BOUNCER_ACQUIRE_TIMEOUT_SECS")]
    pub acquire_timeout: u64,

    /// Timeout (in seconds) when connecting to an upstream server
    #[arg(long, default_value = "10", env = "OMNIS_BOUNCER_CONNECT_TIMEOUT_SECS")]
    ...
    #[arg(long, default_value = "60", env = "OMNIS_BOUNCER_ASSET_CACHE_SECS")]
    pub asset_cache_secs: u64,

    /// Number of connections to buffer while instituting rate limiting (if rate limiting enabled)
    #[arg(long, default_value = "1000", env = "OMNIS_BOUNCER_BUFFER_CONNECTIONS")]
    ...
    #[arg(long, default_value = "3000", env = "OMNIS_BOUNCER_PUBLIC_HTTP_PORT")]
    pub public_http_port: u16,

    /// HTTPS port to listen for requests from the public
    #[arg(long, default_value = "3001", env = "OMNIS_BOUNCER_PUBLIC_HTTPS_PORT")]
    pub public_https_port: u16,

    /// HTTPS port to listen for requests for monitor and control
    #[arg(long, default_value = "2999", env = "OMNIS_BOUNCER_MONITOR_HTTPS_PORT")]
    ...
    #[arg(long, default_value = "5", env = "OMNIS_BOUNCER_STORE_CAPACITY")]
...
fn read_file(path: impl Into<String>) -> Result<Vec<u8>> {
    let path = path.into();
